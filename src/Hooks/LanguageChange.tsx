...
const SetLanguage =(lang:Language, currentLanguage: Language)=>{
    let langTexts=null;
...
export default function LanguageChange({language}:any){
    ...
    useEffect(()=>{
        SetLanguage(language, language); // Dodajemy language jako drugi argument
    },[language]);
    ...
    return(
            ...
            {isHovered&&
                <div className="flex flex-col gap-2 my-auto">
                    <button onClick={() => SetLanguage(language==="pl"?"gb":"pl", language)}>
