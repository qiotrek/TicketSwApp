...
export default function MyAccount() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 2, message: "Powiadomienie 2" },
    { id: 3, message: "Powiadomienie 3" },
  ]);
      ...
      <div className="w-1/3 p-4">
        ...
        <ul className="list-disc list-inside">
          {notifications.map((notification) => (
            ...
            <div id="toast-default" className="flex items-center w-full max-w-xs p-4 my-3 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
